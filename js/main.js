...
//Usando localstorage para añadir data:
...
function addData(){
  ...
  let newMessage = document.createTextNode("Registro correcto!");
  newh3.appendChild(newMessage)
  const currentDiv = document.getElementById("registroExitoso");
  document.body.insertBefore(newh3, currentDiv);
}

//Usando localstorage para traer data:
